...
def expandNode(maxBound, parentNode, startingID, expSeq, currentDirection, foodPos, snakePos=None):
    ...
    for x in list(availableDirections):
        ...
        }, calcFoodDistance(foodPos, state), x, currSnakePos])
