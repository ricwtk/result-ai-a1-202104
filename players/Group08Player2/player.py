...
class Player():
  ...
  def uniform_cost(self, snake_location, food_location):
    goalie = Node()
    frontier = []
    explored = []
    found_goal = False
  ...
  def run(self, problem):
    ...
    solution=self.uniform_cost(problem["snake_locations"],problem["food_locations"])
    directions = "nswe"
...
if __name__ == "__main__":
  ...
  sol, UC = p1.run({'snake_locations': [[0, 5]], 'current_direction': 'e', 'food_locations': [[6, 7]]})
